...
docker run --restart=always --network jason --name accelerator -p 8383:8383 --cap-add NET_ADMIN -e UDP2RAW_PORT=8383 -e KCPTUN_DS=4 -e KCPTUN_PS=4 -d accelerator:latest

docker run --restart=always --network jason --name accelerator -p 8484:8484 --cap-add NET_ADMIN -e UDP2RAW_PORT=8484 -e KCPTUN_DS=4 -e KCPTUN_PS=4 -d accelerator:latest

docker run --restart=always --network jason --name accelerator -p 8585:8585 --cap-add NET_ADMIN -e UDP2RAW_PORT=8585 -e KCPTUN_DS=4 -e KCPTUN_PS=4 -d accelerator:latest
