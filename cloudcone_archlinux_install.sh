...
docker run --restart=always --network jason -e TZ=Asia/Shanghai --name=kcptube -p 58500-58550:58500-58550/udp -v /etc/kcptube:/etc/kcptube -d ghcr.io/thisdk/kcptube:latest /etc/kcptube/config.conf
